frappe.ui.form.on("Task", {
    ...
    refresh(frm) {
        ...
        // Global: fix page title overflow ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ title row 1, buttons row 2
        (function() {
        ...
        if (!frm.is_new() && operationalKinds.includes(frm.doc.task_kind) && ["Open", "Working"].includes(frm.doc.status) && frm.doc.custom_accepted_by !== frappe.session.user) {
