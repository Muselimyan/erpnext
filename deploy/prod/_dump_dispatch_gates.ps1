...
$r = Invoke-RestMethod -Uri "$BaseUrl/api/resource/Server%20Script/$(Enc 'Task-before-save-dispatch-gates')?fields=[`"script`"]" -Headers $Headers -Method Get -TimeoutSec 30
$r.data.script
