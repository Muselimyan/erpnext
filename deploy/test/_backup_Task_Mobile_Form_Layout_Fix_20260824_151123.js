...
@media (max-width: 768px) {
    ...
    body.task-mobile-pack-clean[data-route^="Form/Task"] .page-head .page-actions::-webkit-scrollbar,
    body.task-mobile-pack-clean[data-route^="Form/Task"] .page-head .standard-actions::-webkit-scrollbar,
    body.task-mobile-pack-clean[data-route^="Form/Task"] .page-head .custom-actions::-webkit-scrollbar {
        display: none !important;
    }
