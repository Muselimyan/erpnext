...
IMPROVEMENTS="Snapshot after making Next Task: Assign To visible for Returns processing / verification tasks on test, including Custom Field depends_on update and helper Client Script."
mkdir -p "$DIR"
