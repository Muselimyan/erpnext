...
def main():
    print(f"Patching Processing task subject on TEST only: {BASE_URL}")
    ...
    new = 'new_task.subject = "Account Details: Processing"'
    if old not in script and new not in script:
        raise RuntimeError("Expected subject assignment line not found")
    ...
    print("Patch complete on TEST. Only Processing task subject was changed.")
