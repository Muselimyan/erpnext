...
function task_product_work_area_render_returns(frm, doc, rows, show_alert) {
    ...
    let compact_html = `<div class="task-return-mobile-compact ${mobile_mode === 'detail' ? 'task-return-hidden' : ''}"><table class="table table-bordered table-condensed task-return-compact-table"><thead><tr><th>Ã¢Åâ</th><th>Item</th><th>Returned</th><th>Lost</th></tr></thead><tbody>`;
