...
client_scripts = ["Task-Account Details UI Cleanup", "Task-Other UI Cleanup"]
server_scripts = ["Task-after-save-other-processing", "Task-Other Entry Default Subject"]
