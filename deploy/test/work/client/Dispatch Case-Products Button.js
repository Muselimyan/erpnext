    ...
    refresh: function(frm) {
        ...
        if (!frm.is_new()) {
                    ...
                    fields: [
                            ...
                            onchange: function() {
                                ...
                                if (group && group !== last_loaded_group) {
                                    ...
                                    frappe.call({
                                        ...
                                        callback: function(r) {
                                            all_items = r.message || [];
                                            dc_products_render_items(d, all_items, "");
                                        },
                                        error: function(r) {
                        ...
                        },
                        {
                            ...
                            onchange: function() {
                                ...
                                dc_products_render_items(d, all_items, query);
                            }
                        },
                        {
            ...
            frm.add_custom_button(__("Search & Add Item"), function() {
                let selected_search_items = {};
                let last_search_rendered_query = null;
...
function dc_products_render_items(dialog, items, query) {
    let filtered = items;
    if (query) {
