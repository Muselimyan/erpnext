# ==============================================================
# ERPNext Server Export  -  TEST (test.erpnext.am)
# Outputs:
#   deploy/test/schema/*.json   one file per config / schema type
#   deploy/test/data/*.csv      one file per master-data type (max 20 rows)
#   deploy/test/export-summary.json
# Run with:  powershell -ExecutionPolicy Bypass -File deploy\test\export.ps1
# For prod, use deploy\prod\export.ps1 instead.
...
Write-Host "Exporting from [Test] $BaseUrl" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "============================================================"
Write-Host "Export complete [Test] -> schema/ , data/"
