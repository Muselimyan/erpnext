...
if (window.innerWidth <= 768 && !document.getElementById("mobile-global-css")) {
    ...
    _mcss.textContent = "@media(max-width:768px){.page-actions{gap:2px!important;flex-wrap:nowrap!important}.page-actions .btn{padding:4px 6px!important;font-size:11px!important}.page-head .container{padding-left:8px!important;padding-right:8px!important}body,html,.page-container,.layout-main-section,.layout-main{overflow-y:auto!important;-webkit-overflow-scrolling:touch!important}}img{image-orientation:from-image!important}#mobile-back-btn{touch-action:manipulation}#mobile-back-btn:active{transform:scale(0.9)}";
    ...
    setTimeout(_removeMenuTooltip, 2000);
}
